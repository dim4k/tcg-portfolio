/* ============================================
   ...
   Based on Codrops AmbientCanvasBackgrounds
   Adapted for theme switching
   ============================================ */
...
export class SwirlBackground {
    ...
    drawParticle(x, y, x2, y2, life, ttl, radius, hue) {
        ...
        this.ctx.a.strokeStyle = `hsla(${hue},${saturation}%,60%,${fadeInOut(life, ttl) * 0.5})`;
